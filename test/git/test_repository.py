...
class TestRepository:
    def test_constructor(self):
        ...
        repository = Repository(remote_path='https://github.com/correiajoao/Java.git', local_path='/Users/joaocorreia/PycharmProjects/pfp/input/Java/', branch='master', language=Java())
        assert repository.get_remote_path() == 'https://github.com/correiajoao/Java.git'
        assert repository.get_local_path() == '/Users/joaocorreia/PycharmProjects/pfp/input/Java/'
        assert repository.get_branch() == 'master'
        assert isinstance(repository.get_language(), Java)
        assert repository.get_commits() == list()

        repository = Repository(remote_path='https://github.com/correiajoao/Python.git', local_path='/Users/joaocorreia/PycharmProjects/pfp/input/Python/', branch='master', language=Python())
        assert repository.get_remote_path() == 'https://github.com/correiajoao/Python.git'
        assert repository.get_local_path() == '/Users/joaocorreia/PycharmProjects/pfp/input/Python/'
        assert repository.get_branch() == 'master'
    ...
    def test_getters_and_setters(self):
        ...
        repository.set_remote_path('https://github.com/correiajoao/Java.git')
        repository.set_local_path('/Users/joaocorreia/PycharmProjects/pfp/input/Java/')
